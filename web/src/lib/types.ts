...
export type SalesOrderPlan = S["SalesOrderPlanOut"];
export type PlannedOrder = S["PlannedOrderOut"];
export type BranchAlternative = S["AlternativeOut"];
export type SuggestedPrice = S["SuggestedPriceOut"];
